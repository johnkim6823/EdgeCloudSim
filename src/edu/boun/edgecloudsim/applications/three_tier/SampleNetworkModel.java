...
public class SampleNetworkModel extends NetworkModel {
	...
	public void initialize() {
		wanClients = new int[SimSettings.getInstance().getNumOfEdgeDatacenters()]; // we have one access point for each
																					// datacenter
		wlanClients = new int[SimSettings.getInstance().getNumOfEdgeDatacenters()]; // we have one access point for each
																					// datacenter
	...
	private double getWlanDownloadDelay(Location accessPointLocation, double dataSize) {
		...
		if (numOfWlanUser < experimentalWlanDelay.length)
			result = taskSizeInKb /* Kb */ / (experimentalWlanDelay[numOfWlanUser] * (double) 3) /* Kbps */; // 802.11ac
																												// is
																												// around
																												// 3
																												// times
		...
		// System.out.println("--> " + numOfWlanUser + " user, " + taskSizeInKb + " KB,
		// " +result + " sec");
		return result;
	}
	...
	private double getWanDownloadDelay(Location accessPointLocation, double dataSize) {
		...
		// System.out.println("--> " + numOfWanUser + " user, " + taskSizeInKb + " KB, "
		// +result + " sec");
	...
	private double getManDownloadDelay() {
		...
		// System.out.println("--> " + SimManager.getInstance().getNumOfMobileDevice() +
		// " user, " +result + " sec");
	...
	private double getManUploadDelay() {
		...
		// SimManager.getInstance().getNumOfMobileDevice() + " user, " + result + "
		// sec");
